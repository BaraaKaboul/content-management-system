<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('dashboard.users.index')}}"><i class="icon-user-follow"></i> Users</a>
                <a class="nav-link" href="{{route('dashboard.users.create')}}"><i class="icon-people"></i>Add User</a>
